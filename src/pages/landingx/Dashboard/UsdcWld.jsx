            ...
            <div class="h-full w-full flex font-normal flex-col items-center">
              <div class=" flex flex-col justify-center w-11/12 md:w-full mt-10">
                <p class="flex flex-col w-72 md:w-80 lg:w-96 text-base">
                  <span class="text-sm pb-2 font-semibold">Enter Name:</span>
                  <input
                    type="text"
                ...
                <p class="flex flex-col w-72 md:w-80 lg:w-96 text-base">
                  <span class="text-sm pb-2 font-semibold">Enter BIC:</span>
                  <input
                    type="text/number"
                    onChange={handleChange}
                    // value={withdrawal.address}
                ...
                <p class="flex flex-col w-72 md:w-80 lg:w-96 text-base">
                  <span class="text-sm pb-2 font-semibold">Enter IBAN(account number):</span>
                  <input
                    type="text/number"
                    onChange={handleChange}
                    // value={withdrawal.address}
                ...
                <button
                  ...
                  class="mb-8 px-3 py-1.5 md:w-72_ md:w-80 lg:w-full md:py-2.5 text-sm bg-red-500 text-white font-medium rounded uppercase mt-3 md:mt-0"
                >
                  Withdraw
                </button>
              </div>
